...
We can express this as the **compound proposition** $C(b_{\text{blue}} \oplus  b_{\text{white}} \oplus b_{\text{black}}$) where $\oplus$ represents **exclusive or**. We can enforce this condition simply by expecting only one answer. 
